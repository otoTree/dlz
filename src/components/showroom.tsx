    ...
    <>
      ...
      <section id="showroom" className="py-16 bg-white">
        <div className="container-wrapper">
          <h2 className="section-title">Capabilities Showroom</h2>
          ...
          <div className="bg-gray-50 p-8 rounded-md shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div className="relative rounded-md overflow-hidden shadow-md aspect-[3/4]">
                <Image
                  src={activeProduct.image}
                  alt={activeProduct.name}
                  fill
                  className="object-cover"
                  priority={activeCategory === productCategories[0].id} // 首张图片预加载
                  sizes="(max-width: 768px) 100vw, 50vw"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent" />
              </div>
              <div>
                <h3 className="text-2xl font-medium mb-4 text-[#4baaa4]">
                  {activeProduct.name}
                </h3>
